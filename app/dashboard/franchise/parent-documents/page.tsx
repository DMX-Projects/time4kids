        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-[#374151]">
                    Upload documents that parents will see in Parent Important Documents. Use the form below for each file.
                    Photos and videos for parents can also be added under Events / Gallery.
                </p>
            </div>
