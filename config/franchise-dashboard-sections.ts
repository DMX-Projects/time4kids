...
export const FRANCHISE_DASHBOARD_SECTIONS: FranchiseResourceSection[] = [
    {
        ...
        items: [
            ...
            { title: "Concept Room Pictures & Displays", description: "Reference visuals for room setups and in-centre branding.", actions: [{ label: "Manage", href: "/dashboard/franchise/parent-portal/?tab=showcase" }] },
            ...
            { title: "Artworks", description: "Print-ready creative assets and resizing guidelines.", actions: [{ label: "Manage", href: "/dashboard/franchise/parent-portal/?tab=showcase" }] },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Summer Camp", description: "Camp planners, activity kits, and marketing ready files.", actions: [{ label: "Manage", href: "/dashboard/franchise/parent-portal/?tab=showcase" }] },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Artworks", description: "Brand-safe creatives ready for print and digital.", actions: [{ label: "Manage", href: "/dashboard/franchise/parent-portal/?tab=showcase" }] },
            ...
            { title: "Latest Events (Images & Videos)", description: "Approved galleries for campaigns and PR.", actions: [{ label: "Manage", href: "/dashboard/franchise/parent-portal/?tab=showcase" }] },
            { title: "Concept Room Pictures & Displays", description: "Visual references for campaigns inside centres.", actions: [{ label: "Manage", href: "/dashboard/franchise/parent-portal/?tab=showcase" }] },
        ],
    },
    {
        id: "operations",
    ...
    },
    {
        ...
        accent: "blue",
        items: [
            { title: "Latest Events (Images & Videos)", description: "Curated media library for campaigns and parent updates.", actions: [{ label: "Manage", href: "/dashboard/franchise/parent-portal/?tab=showcase" }] },
            { title: "Summer Camp", description: "Event assets, calendars, and recap templates.", actions: [{ label: "Manage", href: "/dashboard/franchise/parent-portal/?tab=showcase" }] },
        ],
    },
    {
        id: "updates",
        ...
        items: [
            {
                ...
                actions: [{ label: "Manage", href: "/dashboard/franchise/parent-portal/?tab=showcase" }],
            },
        ],
    },
];
