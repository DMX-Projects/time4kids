...
export function AdminUpdatesManagement({ approverMode = false }: { approverMode?: boolean }) {
    ...
    return (
        <div className="space-y-6">
            {approverMode && (
                <div>
                    <h1 className="text-2xl font-semibold text-slate-900">Social media approvals</h1>
                    <p className="text-sm text-slate-600">Approve or reject uploads submitted by centres.</p>
                </div>
            )}
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="font-semibold text-slate-900 text-sm">
                                                    {u.title || (u.media_type === "video" ? "Video Upload" : "Image Upload")}
                                                </p>
