...
export default function PublicPageBackLink({ className = "" }: { className?: string }) {
    ...
    return (
        <Link
            ...
            className={`inline-flex shrink-0 items-center gap-1 rounded-full border border-orange-200/80 bg-white px-2 py-1 text-[11px] font-semibold text-[#003366] shadow-sm transition hover:border-orange-300 hover:bg-orange-50 sm:gap-1.5 sm:px-3 sm:py-1.5 sm:text-xs ${className}`}
